...
function ProfileBanner({
  ...
  return (
    <div className="relative dark:bg-[#111318] bg-[#0d0d0d] border-b-4 border-[#f2fbfc]">
      ...
      <div className="px-4 sm:px-6 lg:px-10 py-8 sm:py-10 relative z-10">
        <div className="flex flex-col items-center text-center lg:flex-row lg:items-end lg:text-left gap-6 sm:gap-8">
          {/* Avatar */}
          ...
          <div className="flex-1 w-full min-w-0">
            <h1
              className="font-black text-white mb-1 font-display truncate"
              style={{
            ...
            <p className="text-white/40 text-xs uppercase tracking-[0.15em] mb-4 font-display truncate">
              {form.email}
            </p>
          ...
          <div className="flex flex-row lg:flex-col gap-3 shrink-0 w-full sm:w-auto">
            <button
              className="flex-1 lg:flex-none flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 text-xs font-black uppercase tracking-widest transition-all cursor-pointer font-display"
              style={{
                background: "#d32f2f",
                color: "white",
