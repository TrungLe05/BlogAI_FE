...
import { useAIToolbar } from "@/features/dashboard/hooks/useAIToolbar";
...
function ToolbarBtn({
  ...
  return (
    <button
      ...
      className="rich-toolbar-btn shrink-0"
      style={{
...
export function RichEditor({ content, onChange }: RichEditorProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={toolbarRef}
        className="flex items-center overflow-x-auto flex-nowrap sm:flex-wrap sm:overflow-visible h-full rich-toolbar-scroll"
        style={{
